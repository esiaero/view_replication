...
extern void logicalrefreshmsg_decode(LogicalDecodingContext *ctx, XLogRecordBuffer *buf);
extern void logicalrefreshdata_decode(LogicalDecodingContext *ctx, XLogRecordBuffer *buf);
