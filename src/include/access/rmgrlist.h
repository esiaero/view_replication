...
PG_RMGR(RM_LOGICALREFRESHMSG_ID, "LogicalREFRESHMessage", logicalrefreshmsg_redo, logicalrefreshmsg_desc, logicalrefreshmsg_identify, NULL, NULL, NULL, logicalrefreshmsg_decode)
PG_RMGR(RM_LOGICALREFRESHDATA_ID, "LogicalREFRESHData", logicalrefreshdata_redo, logicalrefreshdata_desc, logicalrefreshdata_identify, NULL, NULL, NULL, logicalrefreshdata_decode)
